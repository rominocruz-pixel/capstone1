...
A responsive personal portfolio website by **Romino Cruz**, built as part of the MST Connect PH Full-Stack Web Development Bootcamp. The site introduces me as an aspiring full-stack web developer and showcases my current skills, projects, contact information, and professional links.

## Live Demo

> Add your GitHub Pages link here after deployment.

[View Portfolio](https://rominocruz-pixel.github.io/capstone1/)
...
### Home / Hero
Introduces **Romino Cruz** as an aspiring full-stack web developer and includes buttons for viewing projects and visiting GitHub.
